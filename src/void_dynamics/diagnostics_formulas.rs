...
pub fn calculate_graph_entropy(degree_distribution: PyReadonlyArray1<f64>) -> PyResult<f64> {
...
mod tests {
    ...
    fn test_calculate_pathology_score() {
        ...
        Python::with_gil(|py| {
            ...
            let score =
                calculate_pathology_score(rates_py.readonly(), diversity_py.readonly()).unwrap();
