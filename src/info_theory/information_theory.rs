...
pub fn calculate_entropy(pk: PyReadonlyArray1<'_, f64>, base: f64) -> PyResult<f64> {
...
pub fn calculate_mutual_information(p_xy: PyReadonlyArray2<'_, f64>, base: f64) -> PyResult<f64> {
...
mod tests {
    ...
    fn test_kl_divergence_identical() {
        ...
        for &probability in &p {
            if probability > 0.0 {
                kl += probability * ((probability / probability).ln() / log_base);
            }
        }
