...
pub fn calculate_modulated_learning_rate(base_eta: f64, total_reward: f64) -> PyResult<f64> {
...
pub fn calculate_modulated_trace_decay(base_gamma: f64, plv: f64) -> PyResult<f64> {
