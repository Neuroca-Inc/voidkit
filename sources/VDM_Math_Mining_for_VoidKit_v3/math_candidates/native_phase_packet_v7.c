...
EXPORT int phase_native_pi_hot_v7(unsigned target_digits,
                                  unsigned probe_digits,
                                  char *outbuf,
                                  size_t outlen,
                                  char *probebuf,
...
EXPORT int phase_native_pi_full_v7(unsigned target_digits,
                                   unsigned probe_digits,
                                   char *outbuf,
                                   size_t outlen,
                                   char *probebuf,
                                   ...
                                   unsigned *first_non9_pos_out) {
    unsigned first_non9 = 0u;
    int rc = phase_native_pi_hot_v7(target_digits, probe_digits, outbuf, outlen, probebuf, probelen,
...
EXPORT int phase_native_pi_hot_benchmark_v7(unsigned target_digits,
                                            unsigned probe_digits,
                                            unsigned reps,
                                            double *min_seconds,
                                            double *mean_seconds) {
    ...
    phase_native_pi_hot_v7(target_digits, probe_digits, buf, (size_t)target_digits + 32u,
...
EXPORT int phase_native_pi_full_benchmark_v7(unsigned target_digits,
                                             unsigned probe_digits,
                                             unsigned reps,
                                             double *min_seconds,
                                             double *mean_seconds) {
    ...
    phase_native_pi_full_v7(target_digits, probe_digits, buf, (size_t)target_digits + 32u,
...
EXPORT void phase_native_reset_v7(void) {
    agm_clear(&g_agm);
}
