...
EXPORT int phase_local_prepare_v10(unsigned required_decimal_digits,
                                  unsigned probe_digits,
                                  double *seconds_out,
                                  unsigned *iters_out,
...
EXPORT int phase_local_query_v10(unsigned base,
                                unsigned start,
                                unsigned length,
                                unsigned probe_digits,
                                char *outbuf,
...
EXPORT int phase_reference_query_v10(unsigned base,
                                    unsigned start,
                                    unsigned length,
                                    unsigned probe_digits,
                                    char *outbuf,
...
EXPORT int phase_local_query_benchmark_v10(unsigned base,
                                          unsigned start,
                                          unsigned length,
                                          unsigned probe_digits,
                                          unsigned reps,
    ...
    for (unsigned i = 0u; i < reps; ++i) {
        double secs = 0.0;
        phase_local_query_v10(base, start, length, probe_digits, out, (size_t)length + 2u,
...
EXPORT void phase_local_reset_v10(void) {
    clear_state(&g_state);
}
